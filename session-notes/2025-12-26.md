...
### CTA Updates - Redirect to Practice Better

Updated all "Apply" CTA buttons across the site to redirect to Practice Better login instead of the website's apply.html form (kept as fallback):

| Page | CTAs Updated |
|------|--------------|
| `/htma.html` | 5 CTAs |
| `/services/intentional-reset.html` | 3 CTAs |
| `/about.html` | 1 CTA |
| `/drafts/about-v2.html` | 1 CTA |

### Portal Redirect Popup Implementation

Created a polished popup overlay that appears when users click Practice Better CTAs:

**Features:**
- Full-screen overlay with cream background
- Centered logo (200px)
- "Continuing to Secure Portal" title
- Animated bouncing dots
- "HIPAA Compliant & Secure" badge with shield icon
- 1.5 second delay before redirect

**Technical Implementation:**
- JavaScript in `/js/main.js` listens for clicks on `[data-portal]` elements
- Creates overlay dynamically and triggers fade-in animation
- Redirects to Practice Better form after delay

**CTAs Updated (added `data-portal` attribute):**
| Page | CTAs |
|------|------|
| `/htma.html` | 5 |
| `/services/services.html` | 4 |
| `/services/intentional-reset.html` | 3 |
| `/about.html` | 1 |
| `/drafts/about-v2.html` | 1 |
...
| File | Changes |
|------|---------|
| `/js/main.js` | Added portal redirect overlay functionality |
| `/css/main.css` | Added popup overlay styles with animations |
| `/htma.html` | Added `data-portal` to 5 CTAs |
| `/services/services.html` | Added `data-portal` to 4 CTAs |
| `/services/intentional-reset.html` | Added `data-portal` to 3 CTAs |
| `/about.html` | Added `data-portal` to 1 CTA |
| `/drafts/about-v2.html` | Added `data-portal` to 1 CTA |
